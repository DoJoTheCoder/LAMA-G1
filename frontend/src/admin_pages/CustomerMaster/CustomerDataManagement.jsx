...
export default function CustomerDataManagement() {
  ...
  const handleDelete = (e, arg) => {
    e.preventDefault();
    console.log(arg);
    axios.delete("http://localhost:8080/deleteEmp/" + arg).then((response) => {
  ...
  return (
    <div className="lead">
                ...
                <tr key={employee.employeeId}>
                  ...
                  <td>
                    <Link
                      ...
                      to={"/admin/addCustomer/" + employee.employeeId}
                    >
                      Edit
                    </Link>
                    <Link onClick={(e) => handleDelete(e, employee.employeeId)}>
                      Delete
                    </Link>
                  </td>
      ...
      <Link
        className="btn btn-outline-dark text-center mx-1 m-4"
