  ...
  return (
    <div>
      <div className="px-4 pt-5 my-5 text-center border-bottom">
          <h1 className="display-4 fw-bold text-body-emphasis">Welcome Admin {username}</h1>
          <div className="col-lg-6 mx-auto">
            ...
            <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5 text-break">
              ...
              <Link type="button" className="btn btn-primary btn-lg px-4 me-sm-3 bg-dark text-nowrap" to="/admin/customer-data-management">Customer Management</Link>
              ...
              <Link type="button" className="btn btn-primary btn-lg px-4 me-sm-3 bg-dark text-nowrap" to="/admin/item-master-management">Item Management</Link>
            </div>
          </div>
